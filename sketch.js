...
function setup() {
  ...
  box1 = new Rectangle(300,175,100,50);
  box2 = new Rectangle(300,225,50,50);
  box3 = new Rectangle(375,250,50, 50);
  box4 = new Rectangle(225,250,50, 50);
  box5 = new Rectangle(325,250,60,50);
  box6 = new Rectangle(275,250,60,50);
  box7 = new Rectangle(375,300,50, 50);
  box8 = new Rectangle(225,300,50, 50);
